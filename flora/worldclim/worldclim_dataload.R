...
bioclimvars <- function(bioclim) { return(data.frame(llply(bioclim, floraworldclim, .parallel=TRUE))) }

# Create dataframe with all data
flora.exp <- merge(flora(), bioclimvars(bioclim), all.x = TRUE)
# Data can be written to a csv file as below:
